  ...
  <div class="small-12 medium-12 large-12 columns entry-content">	
	...
	<div class="small-5 columns">
	 <ul class="auditionee-type">
	   ...
	   <li><a class="current" href="<?php bloginfo('url'); ?>/audition-profiles/batch-1-maybe/">Maybe</a></li>
	 </ul>
	</div>
	<div class="small-3 columns">
  	<a class="button expand" id="toggle_compact">Compact View</a>
	</div> 
</div>

<? 
/*
  Template Name: Batch 1 Creatives
*/
 get_header(); ?>
	</div>
	 ...
	 <ul class="auditionee-type">
	   <?php
        ...
        if ($user_id ==  194 || $user_id ==  195 ) { ?>
          <li><a class="current" href="<?php bloginfo('url'); ?>/audition-profiles/batch-1-creatives/">Batch 1</a></li>
          <li><a href="<?php bloginfo('url'); ?>/audition-profiles/batch-2-creatives/">Batch 2</a></li>
       <?php } else { ?>
    	   ...
    	   <li><a href="<?php bloginfo('url'); ?>/audition-profiles/batch-1-discuss/">Discuss</a></li>
    	   <li><a href="<?php bloginfo('url'); ?>/audition-profiles/batch-1-no/">No</a></li>
  	   <?php } ?>
  	   <li><a class="current" href="<?php bloginfo('url'); ?>/audition-profiles/batch-1-creatives/">For Creatives</a></li>
	 </ul>
	</div>

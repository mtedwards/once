<? 
/*
  Template Name: Kelly All Unprocessed
*/
 get_header(); ?>
	</div>
...
<div class="row">
  ...
  <?php 
	...
	<div class="small-4 columns">
		  <h3>All Auditionee's - Kelly Unprocessed</h3>
	</div>
	<div class="small-5 columns">
	 <ul class="auditionee-type">
	   <li><a class="current" href="<?php bloginfo('url'); ?>/batches-kelly-unprocessed/">Kelly Unprocessed All</a></li>
	   ...
	   <li><a href="<?php bloginfo('url'); ?>/batch-2-kelly/">Batch 2 - Kelly No</a></li>
